...
def plot_nvidia_smi_data(csv, output_file):
    ...
    if os.path.isfile(csv):
        df = pd.read_csv(csv, delimiter=", ", engine="python")
    else:
    ...
    fig.suptitle(f"NVIDIA H100 80GB HBM3 metrics for Transformers Run", fontsize=16)
...
if __name__ == "__main__":
    ...
    plot_nvidia_smi_data(data, outfile)